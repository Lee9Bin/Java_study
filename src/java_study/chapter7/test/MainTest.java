package java_study.chapter7.test;
...
public class MainTest {
    ...
    public void createStudent(){
        ...
        Sungbo.addStudent(student1);
        Sungbo.addStudent(student2);
        Sungbo.addStudent(student3);
        Sungbo.addStudent(student4);
        Sungbo.addStudent(student5);
